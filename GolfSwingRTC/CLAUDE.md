...
xcodebuild -workspace ../GolfSwingRTC.xcworkspace -scheme GolfSwingRTC -destination 'platform=iOS Simulator,name=iPhone 15' build
...
```bash
# Run unit tests
xcodebuild -workspace ../GolfSwingRTC.xcworkspace -scheme GolfSwingRTC -destination 'platform=iOS Simulator,name=iPhone 15' test

# Run specific test target
xcodebuild -workspace ../GolfSwingRTC.xcworkspace -scheme GolfSwingRTC -destination 'platform=iOS Simulator,name=iPhone 15' -only-testing:GolfSwingRTCTests test
```
