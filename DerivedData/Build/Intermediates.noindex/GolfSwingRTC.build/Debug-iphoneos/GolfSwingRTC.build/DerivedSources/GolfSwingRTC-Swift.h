...
#ifndef GOLFSWINGRTC_SWIFT_H
#define GOLFSWINGRTC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GolfSwingRTC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12GolfSwingRTC11AppDelegate")
...
@class RTCVideoFrame;
SWIFT_CLASS("_TtC12GolfSwingRTC18DebugVideoRenderer")
@interface DebugVideoRenderer : NSObject <RTCVideoRenderer>
- (void)setSize:(CGSize)size;
- (void)renderFrame:(RTCVideoFrame * _Nullable)frame;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12GolfSwingRTC11MPCSignaler")
@interface MPCSignaler : NSObject
...
@class NSData;
@class MCSession;
@interface MPCSignaler (SWIFT_EXTENSION(GolfSwingRTC)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MPCSignaler (SWIFT_EXTENSION(GolfSwingRTC)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MPCSignaler (SWIFT_EXTENSION(GolfSwingRTC)) <MCSessionDelegate>
...
- (void)session:(MCSession * _Nonnull)session didReceiveStream:(NSInputStream * _Nonnull)stream withName:(NSString * _Nonnull)name fromPeer:(MCPeerID * _Nonnull)peerID;
- (void)session:(MCSession * _Nonnull)session didStartReceivingResourceWithName:(NSString * _Nonnull)name fromPeer:(MCPeerID * _Nonnull)peerID withProgress:(NSProgress * _Nonnull)progress;
- (void)session:(MCSession * _Nonnull)session didFinishReceivingResourceWithName:(NSString * _Nonnull)name fromPeer:(MCPeerID * _Nonnull)peerID atURL:(NSURL * _Nullable)localURL withError:(NSError * _Nullable)error;
@end
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC12GolfSwingRTC22ReceiverViewController")
@interface ReceiverViewController : UIViewController <RTCPeerConnectionDelegate>
- (void)viewDidLoad;
...
- (void)peerConnection:(RTCPeerConnection * _Nonnull)peerConnection didAddReceiver:(RTCRtpReceiver * _Nonnull)rtpReceiver streams:(NSArray<RTCMediaStream *> * _Nonnull)streams;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12GolfSwingRTC18RootViewController")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC12GolfSwingRTC13SceneDelegate")
...
SWIFT_CLASS("_TtC12GolfSwingRTC20SenderViewController")
@interface SenderViewController : UIViewController <RTCPeerConnectionDelegate, RTCVideoCapturerDelegate>
- (void)viewDidLoad;
- (void)peerConnection:(RTCPeerConnection * _Nonnull)peerConnection didChangeSignalingState:(RTCSignalingState)stateChanged;
- (void)peerConnection:(RTCPeerConnection * _Nonnull)peerConnection didAddStream:(RTCMediaStream * _Nonnull)stream;
- (void)peerConnection:(RTCPeerConnection * _Nonnull)peerConnection didRemoveStream:(RTCMediaStream * _Nonnull)stream;
