...
**Physical Device IDs:**
- Gold (iPhone, iOS 15.8.5): `4bfc83fa95bf616526d1e5ef203738504c74b4eb` - **SENDER/CAMERA**
- Orange (iPad, iOS 18.6.2): `00008030-000C556E2600202E` - **RECEIVER/VIEWER**

**Build for Devices:**
```bash
# Build for Gold (iPhone/Sender)
cd .. && xcodebuild -workspace GolfSwingRTC.xcworkspace -scheme GolfSwingRTC -destination 'platform=iOS,id=4bfc83fa95bf616526d1e5ef203738504c74b4eb' -derivedDataPath ./DerivedData clean build
...
**Deploy to Devices:**
```bash
# Deploy to Gold (iPhone) - newer iOS versions
cd .. && xcrun devicectl device install app --device 4bfc83fa95bf616526d1e5ef203738504c74b4eb "DerivedData/Build/Products/Debug-iphoneos/GolfSwingRTC.app"
